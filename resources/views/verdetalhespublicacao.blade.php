                    ...
                    <div>
                        <table class="table  table-striped table-bordered table-hover dataTable no-footer textoEsquerda" id="teste" role="grid">
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Nome</th>
                                <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">CPF</th>
                                ...
                                <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Data Visualização</th>
...
var TableAdvanced = function() {
    ...
    var initTable1 = function() {
        ...
        table.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('getverdetalhespublicacao',[$id_publicacao, $listagem]) }}",
            "columns": [
                {data: 'id', name: 'id'},
                ...
                {data: 'data_cadastro', name: 'data_cadastro', "render": function ( data, type, row, meta )
                    {
                ...
                {data: 'data_visualizacao', name: 'data_visualizacao', "render": function ( data, type, row, meta )
                    {
                            var dataAtual = new Date(data);
                            var dia = dataAtual.getDate();
                            var mes = dataAtual.getMonth()+1;
                ...
                {data: 'id', "render": function ( data, type, row, meta )
                    {
                        return '<a href="clientes/detalhescliente/'+data+'" data-toggle="tooltip" data-placement="top" title="" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye text-success"></i>';
                    }
                }
            ],
