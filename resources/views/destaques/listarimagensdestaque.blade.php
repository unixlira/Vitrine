        ...
        <div class="row">
            <div class="col-lg-6">
                <h4 class="nav_top_align">
                    ...
                    Imagens do Destaque: {{$titulo_destaque}}
                </h4>
            </div>
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body m-t-15">
                        <div class="pull-right" style="margin-top: -5px !important;">
                            <a href="{{ URL::to('destaques/novaimgdestaque/'.$id_destaque) }}" id="editable_table_new" class="btn btn-info {{($qtde_imagens == 12 ? 'disabled' : '')}}">
                                Nova Imagem  <i class="fa fa-plus"></i>
                            </a>
                        </div>
                        <table class="table table-striped table-bordered table-hover dataTable no-footer textoEsquerda" id="teste" role="grid">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Imagem</th>
...
var TableAdvanced = function() {
    ...
    var initTable1 = function() {
        ...
        table.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('destaques.getimagensdestaque', $id_destaque) }}",
            "columns": [            
                {data: 'id', name: 'id'},
                {data: 'imagem', "render": function ( data, type, row, meta )
                    {
                        return '<img src="../../assets/img/imgdestaques/'+data+'")}}" style=" width: 40px !important; height: 35px !important; position: relative;"/>';
                    }
                },
                ...
                {data: 'id', "render": function ( data, type, row, meta )
                    {
                        if ("{{Request::session()->get('permissao')}}" != 2) {
                            return '<a href="../verimgdestaque/'+data+'" data-toggle="tooltip" data-placement="top" title="Ver Imagem" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye text-success"></i></a><a class="delete hidden-xs hidden-sm" data-toggle="tooltip" data-placement="top" title="Excluir" href="../excluirimgdestaque/'+data+'/{{$id_destaque}}" data-original-title="Excluir"><i class="fa fa-trash text-danger"></i></a>';
                        }else{
                            return '<a href="../verimgdestaque/'+data+'" data-toggle="tooltip" data-placement="top" title="Ver Imagem" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye text-success"></i></a>';
                        }
                    }
                }
            ],
