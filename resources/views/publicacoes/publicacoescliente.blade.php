        ...
        <div class="row">
            <div class="col-lg-6">
                <h4 class="nav_top_align">
                    ...
                    Ofertas Participante: {{$publicacao->nome_razao_social}}
                </h4>
            </div>
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body m-t-15">
                        <div class="pull-right" style="margin-top: -5px !important;">
                            <a href="{{ URL::to('ofertas/ofertasativas') }}" id="editable_table_new" class="btn btn-info">
                                Ver as ofertas ativas  <i class="fa fa-plus"></i>
                            </a>
                        </div>
                        <table class="table table-striped table-bordered table-hover dataTable no-footer textoEsquerda" id="teste" role="grid">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc wid-10" tabindex="0" rowspan="1" colspan="1">Adesão</th>
                                    <th class="sorting_asc wid-10" tabindex="0" rowspan="1" colspan="1">Data Adesão</th>
...
var TableAdvanced = function() {
    ...
    var initTable1 = function() {
        ...
        table.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('datatable.getpublicacoesclientes',$id) }}",
            "columns": [
                {data: 'id', name: 'id'},
                ...
                {data: 'status_oferta', name: 'status_oferta', 'render': function ( data, type, row, meta )
                    {
                        if (data == 0) {
                            return 'Não aderiu';
                        }else{
                ...
                {data: 'data_adesao', name: 'data_adesao', "render": function ( data, type, row, meta )
                    {
                        var dataAtual = new Date(data);
                        var dia = dataAtual.getDate();
                        var mes = dataAtual.getMonth()+1;
                ...
                {data: 'id', "render": function ( data, type, row, meta )
                    {
                      return '<a href="../publicacoes/'+data+'" data-toggle="tooltip" data-placement="top" title="" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye text-success"></i></a>';
                    }
                }
            ],
