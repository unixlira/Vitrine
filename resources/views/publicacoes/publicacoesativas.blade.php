            ...
            <div class="col-lg-6">
                <div class="float-right">
                    <ol class="breadcrumb nav_breadcrumb_top_align">
                        ...
                        <li class="breadcrumb-item active">Publicações Ativas</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 data_tables">
                <div class="card">
                    <div class="card-body m-t-15">
                        <div class="pull-right" style="margin-top: -5px !important;">
                            <a href="{{ URL::to('publicacoes/publicacoesfuturas') }}" class="btn btn-success">
                                Ver Publicações Futuras  <i class="fa fa-plus"></i>
                            </a>
                            <a href="{{ URL::to('publicacoes/publicacoesinativas') }}" class="btn btn-primary">
                                Ver Publicações Inativas  <i class="fa fa-plus"></i>
                            </a>
                            @if(Request::session()->get('permissao') != 2)
                                <a href="{{ URL::to('publicacoes/novapublicacao') }}" id="editable_table_new" class="btn btn-info">
                                    Nova Publicação  <i class="fa fa-plus"></i>
                                </a>
                                <a href="{{ URL::to('publicacoes/ordenacaoof') }}" class="btn btn-warning">
                                    Ver Ordenação  <i class="fa fa-list"></i>
                                </a>
                                <!--
                                    <a href="http://localhost/webservices/gerar_csv.php?tb=ofertas&usr={{Request::session()->get('id_usuario')}}" class="btn btn-success"> Gerar CSV Ofertas  <i class="fa fa-download"></i></a>
                                    <a href="http://dashboard-magictv.com.br/nagumoplay/webservices/gerar_csv.php?tb=ofertas_participantes&usr={{Request::session()->get('id_usuario')}}" class="btn btn-success"> Gerar CSV Ofertas Aderidas  <i class="fa fa-download"></i></a>
                                -->
                            @endif
                        </div>
                        <table class="table table-striped table-bordered table-hover dataTable no-footer textoEsquerda" id="teste" role="grid">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Categoria</th>
...
var TableAdvanced = function() {
    ...
    var initTable1 = function() {
        ...
        table.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('publicacoes.getpublicacoes') }}",
            "columns": [            
                {data: 'id', name: 'id'},
                ...
                {data: 'id', "render": function ( data, type, row, meta )
                    {
                        if ("{{Request::session()->get('permissao')}}" != 2) {
                            return '<a href="publicacoes/'+data+'" data-toggle="tooltip" data-placement="top" title="Ver Oferta" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye text-success"></i></a><a class="delete hidden-xs hidden-sm margemDir" data-toggle="tooltip" data-placement="top" title="Participantes" href="clientesdapublicacao/'+data+'" data-original-title="Participantes"><i class="fa fa-user-o text-info"></i></a><a class="delete hidden-xs hidden-sm" data-toggle="tooltip" data-placement="top" title="Excluir Oferta" href="excluirpublicacao/'+data+'" data-original-title="Excluir"><i class="fa fa-trash text-danger"></i></a>';
                        }else{
                            return '<a href="publicacoes/'+data+'" data-toggle="tooltip" data-placement="top" title="Ver Oferta" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye text-success"></i></a><a class="delete hidden-xs hidden-sm margemDir" data-toggle="tooltip" data-placement="top" title="Participantes" href="clientesdapublicacao/'+data+'" data-original-title="Participantes"><i class="fa fa-user-o text-info"></i></a>';
                        }
                    }
