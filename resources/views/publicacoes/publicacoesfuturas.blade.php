            ...
            <div class="col-lg-6">
                <div class="float-right">
                    <ol class="breadcrumb nav_breadcrumb_top_align">
                        ...
                        <li class="breadcrumb-item active">Publicações Futuras</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body m-t-15">
                        <div class="pull-right" style="margin-top: -5px !important;">
                            <a href="{{ URL::to('publicacoes/publicacoesativas') }}" class="btn btn-success">
...
var TableAdvanced = function() {
    ...
    var initTable1 = function() {
        ...
        table.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('publicacoes.getpublicacoesfuturas') }}",
            "columns": [            
                {data: 'id', name: 'id'},
