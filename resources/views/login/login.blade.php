...
<html>
<head>
    <title>Login | Morumbi Shopping</title>
            ...
            <div class="row">
                <div class="col-lg-5  col-md-8  col-sm-12 mx-auto card">
                    ...
                    <div class="bg-white login_content login_border_radius">
                        <form action="{{url('login/valida_login')}}" id="login_validator" method="post" enctype="multipart/form-data" class="login_validator">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <input type="submit" value="Entrar" class="btn btn-success btn-block login_button">
                                    </div>
                                </div>
                            </div>
                        </form>
...
<footer class="footer navbar-fixed-bottom">
    <div class="container-fluid m-0">
        <div class="textoFooter ">Desenvolvido por Magic TV &reg; 2018. Todos os Direitos Reservados.</div>    
    </div>
</footer>
<!-- global js -->
