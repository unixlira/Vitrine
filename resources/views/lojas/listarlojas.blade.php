            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 col-sm-8 col-12">
                    <ol class="breadcrumb float-right  nav_breadcrumb_top_align">
                        ...
                        <li class="active breadcrumb-item">Lista de Lojas</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body m-t-15" id="user_body">
                <div class="pull-right">
                    <a href="{{ URL::to('lojas/novaloja') }}" class="btn btn-info">
                        Adicionar Loja  <i class="fa fa-plus"></i>
                    </a>
                </div>
                    ...
                    <div>
                        <table class="table  table-striped table-bordered table-hover dataTable no-footer textoEsquerda" id="teste" role="grid">
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Loja</th>
                                <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">E-Mail</th>
                                <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Telefone</th>
...
var TableAdvanced = function() {
    ...
    var initTable1 = function() {
        ...
        table.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('lojas.getlojas', 0) }}",
            "columns": [
                {data: 'id', name: 'id'},
                {data: 'nome_loja', name: 'nome_loja'},
                ...
                {data: 'id', "render": function ( data, type, row, meta )
                    {
                        if ("{{Request::session()->get('permissao')}}" != 2) {
                            if (data == 1) {
                                return '<a href="verloja/'+data+'" data-toggle="tooltip" data-placement="top" title="" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye text-success"></i></a>';
                            }else{
                                return '<a href="verloja/'+data+'" data-toggle="tooltip" data-placement="top" title="" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye text-success"></i></a><a href="../indexlojaadm/'+data+'" data-toggle="tooltip" data-placement="top" title="" class="margemDir" data-original-title="Visualizar"><i class="fa fa-info-circle text-info"></i></a><a class="delete hidden-xs hidden-sm" data-toggle="tooltip" data-placement="top" title="" href="excluirloja/'+data+'" data-original-title="Bloquear"><i class="fa fa-ban text-danger"></i></a>';                            
                            }
                        }else{
                            return '<a href="verloja/'+data+'" data-toggle="tooltip" data-placement="top" title="" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye text-success"></i></a>';
                        }
