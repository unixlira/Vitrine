                               ...
                               <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div class="btn_file_position">
                                        <?php
                                            ...
                                            $link = $url[6]; //pegando o parametro passado na URL no server   
                                        ?>
                                        @if((Request::session()->get('id_usuario') == $link)|| Request::session()->get('permissao') != 2)
                                        <a href="{{ URL::to('usuarios/editarusuario/'.$link) }}" class="btn btn-info">Editar Informações</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        <table class="table  table-striped table-bordered table-hover dataTable no-footer textoEsquerda" id="teste" role="grid">
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Data</th>
